...
import ProfileForm from '@/Pages/Profile/Partials/UpdateProfileInformationForm.vue';
import {ref} from "vue";
...
<template>
  <CustomerLayout title="Dati account">
    <div class="mx-auto w-full">
      ...
      <div class="bb-card py-8 px-10 shadow-xl">
        ...
        <div class="my-4">
          ...
          <bb-input type="email" placeholder="Email" v-model="form.email" disabled="true"></bb-input>
        ...
        <div class="my-4">
          ...
          <bb-input type="text" placeholder="Telefono" v-model="form.phone"></bb-input>
