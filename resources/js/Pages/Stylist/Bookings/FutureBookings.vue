...
const { searchQuery, isSearching } = useSearch("stylist.booking.future");
...
<template>
  <StylistLayout title="App. futuri">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 sm:mt-10">
      <div class="mx-auto max-w-3xl">
        <div>
          <p class="text-xl text-bb-gray-800 font-extrabold">Appuntamenti futuri</p>
        </div>
        <div class="my-3">
        ...
        <div v-else>
          <p class="text-bb-gray-800 text-md text-center mt-10">Non sono presenti appuntamenti futuri</p>
        </div>
      </div>
    </div>
  </StylistLayout>
